...
public class ConfigurationFactoryImpl implements ConfigurationFactory {
    ...
    public Collection<ItemProcessorConfiguration> getConfigurations() {
        ...
        configurations.add(new ItemProcessorConfiguration(DUPLICATE_CODE_ITEM_NAME, "com.gildedtros.itemProcessor.SmellyItemProcessor"));
        configurations.add(new ItemProcessorConfiguration(LONG_METHODS_ITEM_NAME, "com.gildedtros.itemProcessor.SmellyItemProcessor"));
        configurations.add(new ItemProcessorConfiguration(UGLY_VARIABLE_NAMES_ITEM_NAME, "com.gildedtros.itemProcessor.SmellyItemProcessor"));
